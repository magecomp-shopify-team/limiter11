...
return [
    ...
    */
    ...
    'app_handle' => env('SHOPIFY_APP_HANDLE', 'limiter11'),

    'theme_enable_id' => env('THEME_BLOCK_ID', '01fc63baa1b099847c49460e0fedb87b'),

    'theme_uuid' => env('THEME_UUID', '5572ad37-eaec-432c-8ed6-6142879472f1'),

    'theme_uuid_url' => env('THEME_UUID_URL', 'rule_base_limit'),
